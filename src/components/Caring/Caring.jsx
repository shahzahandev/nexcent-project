        ...
        <div className="pt-[20px] md:pt-[48px] pb-[96px] font-primary bg-[#ffffff]">
            <Container>
                ...
                <div className="relative md:flex mt-[16px] space-x-[30px] space-y-[80px] md:space-y-0">
                    <img src={marketing1} alt="" className="w-[30%] md:w-[100%] ml-[5px] md:ml-0 z-[1]" />
                    <img src={marketing2} alt="" className="w-[30%] md:w-[100%] ml-[5px] md:ml-0 z-[1]"/>
                    <img src={marketing3} alt="" className="w-[30%] md:w-[100%] ml-[5px] md:ml-0 mb-[80px] md:mb-0 z-[1]"/>
                </div>

                <div className="relative md:flex space-x-[75px] mt-[-80px] ml-5 md:ml-[25px]">
                    <div className="z-[22] bg-[#F5F7FA] p-[16px] rounded-[10px] text-center shadow-[0px_8px_16px_0] shadow-[#ABBED1]/40 absolute md:relative top-[-740px] md:top-[0%] left-0">
                    ...
                    <div className="z-[22] bg-[#F5F7FA] p-[16px] rounded-[10px] md:ml-[6px] text-center shadow-[0px_8px_16px_0] shadow-[#ABBED1]/40 absolute md:relative top-[-420px] md:top-0 left-0]">
                    ...
                    <div className="z-[22] bg-[#F5F7FA] p-[16px] rounded-[10px] md:ml-[10px] text-center shadow-[0px_8px_16px_0] shadow-[#ABBED1]/40 absolute md:relative top-[-50px] md:top-0 left-0">
