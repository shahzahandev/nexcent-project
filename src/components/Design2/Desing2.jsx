...
const Desing2 = () => {
    return (
        <div className=" py-[20px] md:py-[33px] bg-[#F5F7FA] font-primary">
            <Container>
                <div className="md:flex space-x-[78px]">
                    <img src={design2} alt="" className="md:w-[100%] animate-pulse transition-all duration-500" />
                    <div className="flex flex-col">
                        <p className="font-medium text-[14px] md:text-[16px] md:leading-[24px] text-para-color w-[340px] md:w-[748px]">Maecenas dignissim justo eget nulla rutrum molestie. Maecenas lobortis sem dui, vel rutrum risus tincidunt ullamcorper. Proin eu enim metus. Vivamus sed libero ornare, tristique quam in, gravida enim. Nullam ut molestie arcu, at hendrerit elit. Morbi laoreet elit at ligula molestie, nec molestie mi blandit. Suspendisse cursus tellus sed augue ultrices, quis tristique nulla sodales. Suspendisse eget lorem eu turpis vestibulum pretium. Suspendisse potenti. Quisque malesuada enim sapien, vitae placerat ante feugiat eget. Quisque vulputate odio neque, eget efficitur libero condimentum id. Curabitur id nibh id sem dignissim finibus ac sit amet magna.</p>
                        ...
                        <div className="md:flex items-center  mt-[10px] md:mt-[32px] ml-[150px] md:ml-0 space-x-5">
                            <div className="flex md:space-x-[25px] ml-[-150px] md:ml-0">
                                <img src={client1} alt="" />
                                <img src={client2} alt="" />
                                <img src={client3} alt="" />
                                <img src={client4} alt="" />
